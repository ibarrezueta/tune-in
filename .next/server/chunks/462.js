...
var AppBar = /*#__PURE__*/external_react_.forwardRef(function AppBar(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement(Paper_Paper, (0,esm_extends/* default */.Z)({
    ...
    component: "header",
    elevation: 4,
    className: external_clsx_default()(classes.root, classes["position".concat((0,capitalize/* default */.Z)(position))], classes["color".concat((0,capitalize/* default */.Z)(color))], className, position === 'fixed' && 'mui-fixed'),
    ref: ref
  }, other));
});
 false ? 0 : void 0;
...
/* harmony import */ var _ButtonBase__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3092);
